 ...
 * 
 * 
 * import com.cognizant.portfolio_management.DailyMutualFundNAV.controller.
 ...
 * 
 * @SpringBootTest class DailyMutualFundNAVApplicationTests {
 * 
 * 
 * 
 * @Autowired private MutualFundController mutualFundController;
 * 
 * 
 * 
 * @Autowired private MockMvc mvc;
 * 
 * @Test void contextLoads() { assertNotNull(mutualFundController); }
 * 
 * @Test public void testGetDailyAllMutualFundNav() throws Exception {
 ...
 * mvc.perform(get("/dailyMutualFundNav/name/Axis Bluechip fund"));
 * actions.andExpect(status().isOk());
 ...
 * actions.andExpect(jsonPath("$.mutualFundValue").value("9800.0")); }
 * 
 * @Test public void testGetDailyMutualFundNavById() throws Exception {
