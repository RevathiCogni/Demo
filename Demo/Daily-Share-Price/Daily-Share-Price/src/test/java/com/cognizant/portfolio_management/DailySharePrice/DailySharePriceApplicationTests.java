 ...
 * 
 * 
 * import com.cognizant.portfolio_management.DailySharePrice.controller.
 ...
 * 
 * @SpringBootTest class DailySharePriceApplicationTests {
 * 
 * 
 * 
 * @Autowired private ShareDetailsController shareDetailsController;
 * 
 * 
 * 
 * @Autowired private MockMvc mvc;
 * 
 * @Test void contextLoads() { assertNotNull(shareDetailsController); }
 * 
 * @Test public void testGetDailySharePrice() throws Exception { ResultActions
 * actions = mvc.perform(get("/dailySharePrice/name/Amazon"));
 ...
 * 
 * 
 * @Test public void testGetAllDailySharePrice() throws Exception {
 ...
 * 
 * 
 * @Test public void testGetDailySharePriceByIDList() throws Exception {
